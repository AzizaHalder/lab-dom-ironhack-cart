...
// for (let i = 0; i < productsList.length; i +=1){ 
    ...
    // } 
    for (const product of productsList) { total +=updateSubtotal(product) } 
    
    // ITERATION 3
    const totalElm=document.querySelector('#total-value span') totalElm.innerText=total } 
    ...
    // ITERATION 5 function createProduct() 
